...
## Sort with Tie Breaker Column / Second Order Sort
...
## FIND THE LAST CITY IN CASE OF UNKNOWN ROWS
...
## Returning Data of specific rank
rank_by_country <- function(data,column,rank){
        ...
        ## to data frame immediately after. 
